  ...
  constructor() {
    ...
    this._translations = {
      zh: {
        ...
        stateOn: '开',
        stateOff: '关',
        defaultIconPath: '/local/community/HacsRosCard/icon_img/states_device_light_on_icon.png', // 默认图标路径
        entity: '实体',
        executionModes: {
          immediate: '立即执行',
          delayed: '延迟执行',
...
class AiksTvCard extends AiksControlBase {
  ...
  setConfig(config) {
    this._config = { 
      ...
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_tv.png' // 自定义图标路径 
    };
...
class AiksLightCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_light.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksFanCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_fan.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksSceneCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_scene.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksMediaPlayerCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_media_play1.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksClimateCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_climate.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksCoverCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_cover.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
class AiksWeatherCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_weather.png'
    };
    if (this._hass) this.render();
  }
...
class AiksSwitchCard extends AiksControlBase {
  setConfig(config) {
    this._config = {
      ...config,
      entities: Array.isArray(config?.entities) ? [...config.entities] : [],
      icon_path: config.icon_path || '/local/community/HacsRosCard/icon_img/icon_switch.png' // 自定义图标路径
    };
    if (this._hass) this.render();
  }
...
window.customCards.push(
  ...
  name: navigator.language.startsWith('zh') ? '天气(ROS)2' : 'Weather(ROS)',
